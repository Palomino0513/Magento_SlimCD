    ...
    public function execute()
    {
        ...
        if ($order) {
            ...
            $payLoad = [
                ...
                "clientid" => trim($configData['slimcd_API']['client_id']),
                "siteid" => trim($configData['slimcd_API']['site_id']),
                "priceid" => trim($configData['slimcd_API']['price_id']),
                "password" => trim($configData['slimcd_API']['password']),
