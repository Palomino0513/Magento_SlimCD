...
namespace Slimcd\Payment\Webapi\Rest\Request\Deserializer;
...
class XWwwFormUrlencoded implements \Magento\Framework\Webapi\Rest\Request\DeserializerInterface
{
    ...
    /** @var \Slimcd\Payment\Model\PaymentManagement\Decoder */
    protected $decoder;
    ...
    /**
     * @param \Slimcd\Payment\Model\PaymentManagement\Decoder $decoder
     * @param \Magento\Framework\App\State $appState
     */
    public function __construct(\Slimcd\Payment\Model\PaymentManagement\Decoder $decoder, State $appState)
    {
